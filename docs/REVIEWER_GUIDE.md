...
- Source identity: [source manifest](../artifacts/manifests/revision_source_manifest.json); all copied manuscript bytes and normalized inputs have SHA-256 records.
...
- Authority: the paper is preserved as supplied. This guide describes what the available files allow a reviewer to inspect; it does not amend the paper or certify all of its scientific claims.

## Paper-to-evidence map

Table labels below are stable labels in [the clean TeX](../paper/revised_20260906/main.tex).

| Paper location | Repository evidence | Interpretation |
| --- | --- | --- |
| Methodology; Figure 1 | [Code correspondence](MANUSCRIPT_CODE_MAPPING.md), [active figure sources](../paper/revised_20260906/figures/) | Trace PDK/FAA/global gates; documented implementation differences remain |
...
| `tab:binary_confusion` | [Paper table](../paper/revised_20260906/main.tex) | 98.41/1.59 and 2.07/97.93 are complementary mean conditional rates, not pooled counts |
| `tab:complexity` | [Paper](../paper/revised_20260906/main.pdf), [CPU profiling utility](../scripts/profile_phycl_complexity.py) | Reported 184.31→125.99 ms gives 31.6423%, rounded to 31.6%; no new CPU benchmark |
